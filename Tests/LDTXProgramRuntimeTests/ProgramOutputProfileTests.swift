...
struct ProgramOutputProfileTests {
  ...
  @Test func sdr1080p60UsesThePersistedCBRBitRate() {
    let profile = ProgramOutputProfile.sdr1080p60(videoBitRate: 9_000_000)

    #expect(profile.videoBitRate == 9_000_000)
    #expect(profile.makeSegmentedMP4Configuration().videoBitRate == 9_000_000)
  }
}
