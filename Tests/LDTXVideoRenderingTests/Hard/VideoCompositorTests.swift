...
@Suite
struct VideoCompositorHardTests {
  ...
  func diagnosticComponentKindCodesRemainStableWhenRetainedTextureIsAdded() throws {
    ...
    #expect(
      VideoCompositor.componentKindCode(
        .testPattern(
  ...
  func retainedClockTextureCompositesIntoIntegerNV12Planes() throws {
    ...
    let overlay = try clockRenderer.renderClockOverlay(
    ...
    let transparentGlyphs = try clockRenderer.renderClockOverlay(
      ClockOverlayRenderRequest(
        text: "12:34:56",
  ...
  func solidColorProducesNV12PixelBuffer() throws {
    ...
    #expect(
      CVPixelBufferGetPixelFormatType(output) == kCVPixelFormatType_420YpCbCr8BiPlanarFullRange)
  ...
  private func makeNV12InputSource(width: Int, height: Int, device: MTLDevice) throws
    -> MetalVideoSource
  {
