...
public nonisolated struct Ldtx_Automation_V1_InputDeviceSelectParams: Sendable {
  ...
  public var workspaceInputDeviceName: String = String()
...
nonisolated extension Ldtx_Automation_V1_InputDeviceSelectParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}physical_device_id\0\u{3}workspace_input_device_name\0\u{b}workspace_input_device_id\0\u{c}\u{1}\u{1}")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.workspaceInputDeviceName) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.workspaceInputDeviceName.isEmpty {
      try visitor.visitSingularStringField(value: self.workspaceInputDeviceName, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Ldtx_Automation_V1_InputDeviceSelectParams, rhs: Ldtx_Automation_V1_InputDeviceSelectParams) -> Bool {
    if lhs.workspaceInputDeviceName != rhs.workspaceInputDeviceName {return false}
...
nonisolated extension Ldtx_Automation_V1_InputDeviceRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}name\0\u{1}kind\0\u{3}physical_device_id\0\u{b}id\0\u{b}side_track_recording_policy\0\u{c}\u{1}\u{1}\u{c}\u{5}\u{1}")
