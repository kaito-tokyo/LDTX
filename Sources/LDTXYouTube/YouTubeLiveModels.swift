...
public struct YouTubeLiveStream: Codable, Equatable, Sendable, Identifiable {
    ...
    public struct Snippet: Codable, Equatable, Sendable {
        ...
        public init(publishedAt: String? = nil, channelId: String? = nil, title: String, description: String? = nil) {
            self.publishedAt = publishedAt
            self.channelId = channelId
            self.title = title
            self.description = description
    ...
    public struct CDN: Codable, Equatable, Sendable {
        ...
        public init(ingestionType: String, ingestionInfo: IngestionInfo? = nil, resolution: String, frameRate: String) {
    ...
    public struct IngestionInfo: Codable, Equatable, Sendable {
        ...
        public init(streamName: String? = nil, ingestionAddress: String? = nil, backupIngestionAddress: String? = nil) {
