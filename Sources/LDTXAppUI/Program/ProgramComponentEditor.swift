...
struct ProgramComponentEditor: View {
  ...
  private var solidColorBinding: Binding<FillSolidColorComponent> {
    Binding(
      get: {
        if case .fillSolidColor(let payload) = componentBinding.wrappedValue {
          return payload
        }
  ...
  private var linearGradientBinding: Binding<FillLinearGradientComponent> {
    Binding(
      get: {
        if case .fillLinearGradient(let payload) = componentBinding.wrappedValue {
          return payload
        }
  ...
  private var radialGradientBinding: Binding<FillRadialGradientComponent> {
    Binding(
      get: {
        if case .fillRadialGradient(let payload) = componentBinding.wrappedValue {
          return payload
        }
  ...
  private var conicGradientBinding: Binding<FillConicGradientComponent> {
    Binding(
      get: {
        if case .fillConicGradient(let payload) = componentBinding.wrappedValue {
          return payload
        }
  ...
  private var clockBinding: Binding<ClockComponent> {
    Binding(
      get: {
        if case .clock(let payload) = componentBinding.wrappedValue {
          return payload
        }
  ...
  private var inputCameraDeviceBinding: Binding<InputDeviceComponent> {
    Binding(
      get: {
        if case .inputCameraDevice(let payload) = componentBinding.wrappedValue {
          return payload
        }
...
struct ClockStyleControls: View {
  ...
  private func outlineThickness(_ index: Int) -> Binding<Float> {
    Binding(
      get: { component.outlines[index].thickness },
      set: { component.outlines[index].thickness = $0 })
  }
