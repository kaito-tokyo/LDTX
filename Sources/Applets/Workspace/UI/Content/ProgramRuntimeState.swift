...
extension [ProgramInputDeviceRecord] {
  fileprivate func physicalDeviceIDsByID(kind: ProgramInputDeviceKind) -> [String: String] {
...
private func firstInputDevicesByID(
  _ inputDevices: [ProgramInputDeviceRecord]
) -> [String: ProgramInputDeviceRecord] {
  var inputDevicesByID: [String: ProgramInputDeviceRecord] = [:]
