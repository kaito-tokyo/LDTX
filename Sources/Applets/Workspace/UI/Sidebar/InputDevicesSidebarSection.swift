...
struct InputDevicesSidebarSection: View {
  ...
  @ViewBuilder
  private func inputDeviceRow(_ device: ProgramInputDeviceRecord) -> some View {
  ...
  private func inputDeviceSystemImage(
    _ device: ProgramInputDeviceRecord
  ) -> String {
    switch device.kind {
    case .video: "video"
    case .audio: "waveform"
...
struct AddInputDeviceDialog: View {
  @Binding var kind: ProgramInputDeviceKind
...
struct InputDeviceDropDelegate: DropDelegate {
  ...
  static func reordered(
    _ inputDevices: [ProgramInputDeviceRecord], draggedName: String,
