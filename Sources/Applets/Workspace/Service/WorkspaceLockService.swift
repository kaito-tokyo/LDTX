...
public struct WorkspaceLock: Equatable {
  public let url: URL
...
public enum WorkspaceLockError: Error, Equatable, LocalizedError {
...
public struct WorkspaceLockService {
  ...
  public func release(_ lock: WorkspaceLock) {
