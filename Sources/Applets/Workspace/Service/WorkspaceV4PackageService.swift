...
public struct WorkspaceV4PackageService {
  ...
  public func load(at packageURL: URL) throws -> WorkspaceV4Package {
    ...
    {
      throw WorkspaceV4PackageServiceError.unsupportedWorkspaceFormat(packageURL)
    }
    do {
...
public enum WorkspaceV4PackageServiceError: Error, Equatable, LocalizedError, Sendable {
  ...
  case unsupportedWorkspaceFormat(URL)
  ...
  public var errorDescription: String? {
    ...
    case .unsupportedWorkspaceFormat(let url):
      "This Workspace package uses an unsupported format and cannot be opened as Workspace v4: \(url.path)"
    }
  }
}
