...
@MainActor
public final class WorkspaceV4WindowCloseCoordinator: NSObject, NSWindowDelegate {
  public typealias CloseOperation = (@escaping @MainActor @Sendable () -> Void) -> Void
  public typealias SaveOperation = () -> Bool
  public typealias BecomeKeyOperation = () -> Void
  public typealias AfterCloseOperation = @MainActor @Sendable () -> Void

  private let discardsUnsavedChangesOnClose: Bool
  public init(discardsUnsavedChangesOnClose: Bool = LDTXRuntimeMode.discardsUnsavedChangesOnClose) {
    self.discardsUnsavedChangesOnClose = discardsUnsavedChangesOnClose
    super.init()
  }
  public var chooseCloseAction: ((NSWindow) -> NSApplication.ModalResponse)?
  ...
  public func windowDidBecomeKey(_ notification: Notification) { onBecomeKey?() }
