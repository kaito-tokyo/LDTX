...
public struct YouTubeStreamKeyConfigurationStore {
  ...
  public func load() throws -> [YouTubeRTMPSStreamKeyConfiguration] {
    var query = query
  ...
  public func save(_ configurations: [YouTubeRTMPSStreamKeyConfiguration]) throws {
