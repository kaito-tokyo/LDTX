...
public final class SyntheticCaptureService: @unchecked Sendable {
    ...
    public static func makeVideoSampleBuffer(
        ...
        let timing = CMSampleTimingInfo(
            ...
            presentationTimeStamp: CMTime(value: CMTimeValue(frameIndex), timescale: CMTimeScale(frameRate)),
    ...
    private static func fillBiPlanarYUV(
        ...
        for y in 0..<(height / 2) {
            ...
            if chromaLength > 0 {
                Darwin.memset(row.advanced(by: chromaStart), Int32(96 + ((frameIndex / 8) % 64)), chromaLength)
            }
        }
    }
