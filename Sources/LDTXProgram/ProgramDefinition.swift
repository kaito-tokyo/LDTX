...
public struct ProgramPreferences: Codable, Equatable, Sendable {
  ...
  private static func preferenceKey(forName name: String) -> String {
    ...
    return String(
      decoding: name.utf8.flatMap { byte -> [UInt8] in
        let isUnreserved =
  ...
  public mutating func setVideoLayers(
    _ layers: [VideoLayerPreference], forProgramNamed name: String
  ) {
  ...
  public func audioChannelGain(
    for channel: ProgramAudioChannel, in composite: CompositeProgramDefinition
  ) -> Double {
    audioChannelGain(for: channel, in: composite.audioChannels)
  }

  public func audioChannelGain(
    for channel: ProgramAudioChannel, in audioChannels: [ProgramAudioChannel]
  ) -> Double {
...
extension [ProgramInputDeviceRecord] {
  public func resolvedWorkspaceAudioChannels(
    ...
    for channel in storedAudioChannels {
      ...
      case .inputAudioDevice(let payload):
        guard let inputDeviceID = payload.inputDeviceID,
          ...
          representedInputDeviceIDs.insert(inputDeviceID).inserted
        else {
          continue
        }
...
public struct CompositeProgramStep: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
    component =
      try container.decodeIfPresent(ProgramComponent.self, forKey: .component)
      ?? .inputCameraDevice(InputDeviceComponent())
    name =
      try container.decodeIfPresent(String.self, forKey: .name) ?? component.definition.displayName
  }
...
extension ProgramComponentParameters {
  public func encodeComponentParameters(to encoder: Encoder) throws {
...
public struct ProgramAudioChannel: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
    component =
      try container.decodeIfPresent(ProgramAudioChannelComponent.self, forKey: .component)
...
public enum ProgramAudioChannelComponent: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    case .inputAudioDevice:
      self = .inputAudioDevice(
        try container.decodeIfPresent(InputAudioDeviceComponent.self, forKey: .parameters)
          ?? InputAudioDeviceComponent()
      )
    case .silentAudio:
      self = .silentAudio
    case .testPatternAudio:
  ...
  public static func defaultComponent(for definition: ProgramAudioChannelDefinition)
    -> ProgramAudioChannelComponent
  {
    switch definition {
    case .inputAudioDevice:
      .inputAudioDevice(InputAudioDeviceComponent())
  ...
  init(from decoder: Decoder) throws {
    ...
    guard let color = Self.parse(string) else {
      throw DecodingError.dataCorruptedError(
        in: container,
        debugDescription:
          "Expected rgba(<red> <green> <blue> / <alpha>) with RGB integers 0...255 and alpha 0...1."
      )
    }
    self = color
  }
...
public enum ProgramComponent: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    case .fillSolidColor:
      self = .fillSolidColor(
        try container.decode(FillSolidColorComponent.self, forKey: .parameters))
    case .fillLinearGradient:
      self = .fillLinearGradient(
        try container.decode(FillLinearGradientComponent.self, forKey: .parameters))
    case .fillRadialGradient:
      self = .fillRadialGradient(
        try container.decode(FillRadialGradientComponent.self, forKey: .parameters))
    case .fillConicGradient:
      self = .fillConicGradient(
        try container.decode(FillConicGradientComponent.self, forKey: .parameters))
    case .clock:
      self = .clock(
        try container.decodeIfPresent(ClockComponent.self, forKey: .parameters) ?? ClockComponent())
    case .inputCameraDevice:
      self = .inputCameraDevice(
        try container.decode(InputDeviceComponent.self, forKey: .parameters))
    case .testPattern:
      self = .testPattern
    }
  }
  ...
  public static func defaultComponent(for definition: ProgramComponentDefinition)
    -> ProgramComponent
  {
    switch definition {
    case .fillSolidColor:
...
public struct FillSolidColorComponent: ProgramComponentParameters {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      CSSRGBAColor(red: red, green: green, blue: blue, alpha: alpha), forKey: .color0)
...
public struct FillLinearGradientComponent: ProgramComponentParameters {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      CSSRGBAColor(red: startRed, green: startGreen, blue: startBlue, alpha: startAlpha),
      forKey: .color0)
    try container.encode(
      CSSRGBAColor(red: endRed, green: endGreen, blue: endBlue, alpha: endAlpha), forKey: .color1)
    try container.encode(clip, forKey: .clip)
  }
}
...
public struct FillRadialGradientComponent: ProgramComponentParameters {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      CSSRGBAColor(red: innerRed, green: innerGreen, blue: innerBlue, alpha: innerAlpha),
      forKey: .color0)
    try container.encode(
      CSSRGBAColor(red: outerRed, green: outerGreen, blue: outerBlue, alpha: outerAlpha),
      forKey: .color1)
    try container.encode(clip, forKey: .clip)
  }
}
...
public struct ClockComponent: ProgramComponentParameters {
  ...
  public init(from decoder: Decoder) throws {
    ...
    let foreground =
      try container.decodeIfPresent(CSSRGBAColor.self, forKey: .foregroundColor)
    ...
    let legacyBackgroundColor =
      try container.decodeIfPresent(CSSRGBAColor.self, forKey: .backgroundColor)
    ...
    usesSystemTimeZone =
      try container.decodeIfPresent(Bool.self, forKey: .usesSystemTimeZone) ?? true
    utcOffsetMinutes = try container.decodeIfPresent(Int32.self, forKey: .utcOffsetMinutes) ?? 0
    background = try container.decodeIfPresent(String.self, forKey: .background) ?? ""
    outlines = Array(
      (try container.decodeIfPresent([ClockTextOutline].self, forKey: .outlines) ?? []).prefix(2))
  }
...
public struct ProgramInputDeviceRecord: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    captureFrameRateOverride = try container.decodeIfPresent(
      Int.self, forKey: .captureFrameRateOverride)
  }
  ...
  public var hasCaptureOverrides: Bool {
    colorRangePolicy != .unspecified || captureWidthOverride != nil || captureHeightOverride != nil
