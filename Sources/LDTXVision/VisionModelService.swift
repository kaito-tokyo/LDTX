...
public actor VisionModelService {
    ...
    public nonisolated func isDownloaded(model: WorkspaceVisionModel) -> Bool {
        VisionModelCache.snapshotDirectory(for: model) != nil
    }
...
private extension WorkspaceVisionModel {
    var cacheKey: String {
        "\(repositoryID)@\(revision ?? "main")"
    }
}
